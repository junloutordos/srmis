...
class FacilityRequestGSUMail extends Mailable
{
    ...
    {
        // Prepare venue display: resolve facility ids to names if possible
        $venueDisplay = '—';
        try {
        ...
        return $this->subject('GSU Head Action Required: Facility Request')
