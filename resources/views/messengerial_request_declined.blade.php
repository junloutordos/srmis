...
<head>
  <meta charset="utf-8">
  <title>Messengerial Request Declined</title>
  <style>
...
<body>
  <div class="center">
    <div class="card">
      <h1>Messengerial Request Declined</h1>
    ...
    (function(){
      ...
      try {
        if (window.opener && !window.opener.closed) {
          window.opener.postMessage({ type: 'messengerialRequestDeclined', id: id, reason: reason }, '*');
        }
      } catch (e) { }
