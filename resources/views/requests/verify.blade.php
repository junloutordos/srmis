...
<head>
  ...
  <title>Document Verification — {{ $docRef }}</title>
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .doc-title .ref   { font-size: 18px; font-weight: 700; color: #1e293b; }
  ...
  <div class="wrapper">
    ...
    <div class="site-header">
      ...
      <div class="school">
        ...
        <strong>SRMIS Document Verification</strong>
      </div>
    </div>
    ...
    <div class="card">
      <div class="doc-title">
        ...
        <div class="meta">
          {{ $summary }}<br>
          Requested by: <strong>{{ $requester }}</strong><br>
    ...
    <div class="card">
      ...
      <div class="sig-details">
        ...
        <div class="detail-row">
          ...
          <span class="detail-value">{{ $docRef }}</span>
        </div>
        <div class="detail-row">
    ...
    <div class="footer-note">
      This verification page is generated by the SRMIS — Service Requests Management Information System.<br>
