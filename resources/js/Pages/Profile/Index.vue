    ...
    <div class="max-w-3xl space-y-5">
        ...
        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div class="relative shrink-0">
            ...
            <button @click="triggerPhotoInput"
              class="absolute bottom-0 right-0 w-8 h-8 bg-primary-600 hover:bg-primary-700 text-white rounded-full flex items-center justify-center shadow-md transition-colors"
              title="Change photo">
          ...
          <div class="flex-1 text-center sm:text-left">
            ...
            <div class="flex flex-wrap gap-1.5 mt-2 justify-center sm:justify-start">
              <span v-for="role in profile.roles" :key="role"
                class="inline-flex px-2 py-0.5 rounded-full text-[11px] font-semibold bg-primary-100 text-primary-700">
                {{ role }}
              </span>
            </div>
      ...
      <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <h3 class="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
          <PencilSquareIcon class="h-4 w-4 text-primary-500" />
        ...
        <div class="mt-5 flex justify-end">
          <button @click="save" :disabled="submitting"
            class="flex items-center gap-2 px-5 py-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg disabled:opacity-50 transition-colors">
      ...
      <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <h3 class="text-sm font-semibold text-slate-700 mb-1 flex items-center gap-2">
          <FingerPrintIcon class="h-4 w-4 text-primary-500" />
          Digital Signature
        </h3>
        ...
        <a :href="route('profile.signature')"
          class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary-600 border border-primary-200 rounded-lg hover:bg-primary-50 transition-colors">
