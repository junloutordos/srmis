...
class TenantRolesSeeder extends Seeder
{
    public function run(): void
    {
        $roles = [
            ...
            ['name' => 'ITJR Dispatcher', 'description' => 'Dispatches OCD-approved IT Job Requests to MIS personnel for action.'],
            ...
            ['name' => 'GSU Dispatcher', 'description' => 'Assigns drivers and vehicles to vehicle requests before Division Chief approval.'],
