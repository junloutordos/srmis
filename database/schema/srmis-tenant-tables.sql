...
CREATE TABLE `messengerial_requests` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned DEFAULT NULL,
  ...
  `consignee_contact` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `consignee_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_methods` json DEFAULT NULL,
  `messengerial_kinds` json DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
  `division_chief_id` bigint unsigned DEFAULT NULL,
  `decline_reason` text COLLATE utf8mb4_unicode_ci,
  ...
  `rfsf_reference_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `courier_service_provider` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `courier_cost` decimal(10,2) DEFAULT NULL,
  `date_received_by_courier` datetime DEFAULT NULL,
  `date_delivered` datetime DEFAULT NULL,
  `proof_remarks` text COLLATE utf8mb4_unicode_ci,
  `completed_at` timestamp NULL DEFAULT NULL,
  `rated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `messengerial_requests_reference_no_unique` (`reference_no`),
  KEY `messengerial_requests_division_chief_id_foreign` (`division_chief_id`),
  CONSTRAINT `messengerial_requests_division_chief_id_foreign` FOREIGN KEY (`division_chief_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE `messengerial_sequences` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `messengerial_sequences_division_code_year_unique` (`division_code`,`year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `assets` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `assets_property_no_unique` (`property_no`),
  KEY `assets_assigned_user_id_foreign` (`assigned_user_id`),
  KEY `assets_building_id_foreign` (`building_id`),
  KEY `assets_room_id_foreign` (`room_id`),
  CONSTRAINT `assets_assigned_user_id_foreign` FOREIGN KEY (`assigned_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `assets_building_id_foreign` FOREIGN KEY (`building_id`) REFERENCES `buildings` (`id`) ON DELETE SET NULL,
