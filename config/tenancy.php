...
return [
    ...
    /**
     * Tenant ids are explicit campus slugs (oed, crc, src, ...) supplied at
     * provisioning time; the UUID generator is only a fallback.
     */
     ...
     */
    'central_domains' => [
        env('CENTRAL_DOMAIN', 'srmis.localhost'),
        '127.0.0.1',
        'localhost',
    ],
    ...
    'bootstrappers' => [
        ...
        App\Tenancy\PrefixCacheTenancyBootstrapper::class, // prefix-based — works with database/file/redis stores
    ...
    'database' => [
         ...
         */
        'prefix' => env('TENANT_DB_PREFIX', 'srmis_'),
        'suffix' => '',
     ...
     */
    'seeder_parameters' => [
        '--class' => 'TenantDatabaseSeeder', // tenant RBAC + reference data
        '--force' => true,
    ],
];
