...
return [
    ...
    */
    ...
    'agency_name' => env('AGENCY_NAME', 'Philippine Science High School System'),
    'agency_code' => env('AGENCY_CODE', 'PSHS'),

    /*
    | Email domain allowed to sign in (empty = no restriction). Subdomains of
